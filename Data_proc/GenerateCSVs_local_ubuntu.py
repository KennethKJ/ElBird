...
import numpy as np
# Define paths
dB_path = "/media/kennethkj/Data/Google Drive/ML/Databases/Birds_dB/Images"
...
filename_classes = "media/kennethkj/Data/Google Drive/ML/Databases/Mappings/minimal_bird_list.txt"
LIST_OF_CLASSES = [line.strip() for line in open(filename_classes, 'r')]


f = open('media/kennethkj/Data/Google Drive/ML/Databases//Mappings/classes.txt', 'w')
...
for j in range(3):
    ...
    f = open(names[j] + '_set_local_ub.csv', 'w')
    for i in idxs[j]:
