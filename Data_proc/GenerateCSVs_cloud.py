...
bucket_path = "gs://electric-birder-71281-bird-db/Birds_dB/Images/"
# bucket_path = dB_path
...
filename_classes = "D:/ML/Databases/Birds_dB/Mappings/bird_list_selected.txt"
...
for j in range(3):
    ...
    f = open(names[j] + '_set_cloud_full.csv', 'w')
    for i in idxs[j]:
